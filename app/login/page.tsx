            ...
            <section className="absolute inset-0 z-30 flex w-full flex-col p-8 justify-center lg:relative lg:inset-auto lg:w-1/2 lg:p-16 lg:bg-white">
                ...
                <motion.div 
                    ...
                    <motion.img 
                        ...
                        className="h-[250px] w-[250px] object-contain relative top-60 translate-x-[-60px] xs:hidden lg:h-[180px] lg:w-[180px] lg:translate-x-[-40px] lg:translate-y-[-77px] lg:block"
                        animate={{ y: [0, -12, 0] }}
