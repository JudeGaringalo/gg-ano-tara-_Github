  ...
  const loginWithGoogle = async () => {
    ...
    return (
        <div className="flex min-h-screen w-full font-sans text-slate-900">
            ...
            <section className="relative z-30 flex w-full flex-col p-8 md:absolute md:inset-0 md:w-full md:bg-transparent lg:relative lg:w-1/2 lg:p-16 lg:bg-white">
                ...
                className="flex flex-1 flex-col items-center justify-center -translate-y-12">
                ...
                <div className="w-full max-w-[340px] px-6 md:bg-white/10 md:backdrop-blur-md md:p-10 md:rounded-3xl lg:bg-transparent lg:p-0">
                    ...
                    <a href="/" className="group mt-6 flex items-center justify-center gap-2 text-base text-slate-400 transition-colors hover:text-black" >
                        <svg 
                ...
                transition={{ duration: 0.5, delay: 1.2, type: "spring", stiffness: 100 }} >
                    ...
                    className="h-[250px] w-[250px] object-contain relative top-60 translate-x-[-60px] lg:h-[180px] lg:w-[180px] lg:translate-x-[-40px] lg:translate-y-[-77px] md:hidden"
                    animate={{ y: [0, -12, 0] }}
                    transition={{ duration: 3, repeat: Infinity, ease: "easeInOut" }}/>
                </motion.div>
            </section>

            <section className="relative block w-full overflow-hidden md:h-screen lg:w-1/2">
                ...
                <div className="absolute inset-0 z-20 flex flex-col justify-end p-8 md:p-16 text-white">
                    ...
                    <motion.div
                        ...
                        className="max-w-2xl"
                    >
                        <h2 className="mb-4 text-3xl md:text-3xl font-semibold leading-tight tracking-tighter">
